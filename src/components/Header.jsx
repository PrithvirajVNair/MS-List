        ...
        <div className='text-white/60 grid grid-cols-4'>
          ...
          <div className='col-span-2 border rounded-xl backdrop-blur-xl'>
            <ul className='flex flex-col justify-center items-center text-2xl py-5'>
                {showButton && <li><Link to={'/register'}><button className='text-sm py-2 px-5 rounded-xl bg-linear-to-r via-[#000CF1]/60 hover:via-[#000CF1] via-30% from-[#000CF1]/60 hover:from-[#000CF1] to-black/60 hover:to-black text-white cursor-pointer'>Get Started</button></Link></li>}
