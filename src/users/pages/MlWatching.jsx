...
import { getCustomWatchingListAPI, putCustomListAPI, putCustomStatusListAPI } from '../../services/allAPIs';
...
const MlWatching = () => {
    ...
    const getList = async (value) => {
        ...
        const result = await getCustomWatchingListAPI(reqHeader, value)
    ...
    return (
        <>
            <MylistCommon watching count={listCount} onHandleSearch={getList}/>
