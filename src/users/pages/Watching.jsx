...
import { getWatchingListAPI, putListAPI, putStatusListAPI, updateScoreAPI } from '../../services/allAPIs';
...
const Watching = () => {
    ...
    const getList = async (value) => {
        ...
        const result = await getWatchingListAPI(reqHeader, value)
    ...
    return (
        <>
            <WatchlistCommon watching count={listCount} onHandleSearch={getList} />
