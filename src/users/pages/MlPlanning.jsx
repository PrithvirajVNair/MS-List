...
import { getCustomPlanningListAPI, putCustomListAPI, putCustomStatusListAPI } from '../../services/allAPIs'
...
const MlPlanning = () => {
    ...
    const getList = async (value) => {
        ...
        const result = await getCustomPlanningListAPI(reqHeader, value)
    ...
    return (
        <>
            <MylistCommon planning count={listCount} onHandleSearch={getList}/>
