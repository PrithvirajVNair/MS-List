                            ...
                            PopularShows?.length > 0 ?
                                PopularShows?.map((show) => (
                                    <div className='bg-white/10 aspect-4/6  rounded-xl sm:m-3 m-1 relative group overflow-hidden'>
                                        ...
                                        <div className='absolute inset-0 bg-black/90 flex flex-col justify-center items-center opacity-100 group-hover:opacity-100 transition-opacity duration-500'>
