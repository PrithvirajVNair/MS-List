...
const Completed = () => {
  return (
    <>
        <WatchlistCommon completed/>
            <div className='min-h-screen bg-black text-white'>
                <div className='w-full grid grid-cols-5 px-20'>
                    <div className='bg-white/10 h-50 rounded-xl m-3 relative group overflow-hidden'>
                        <div className='flex m-2'>
                            ...
                            <div>
                                <p className='text-white/60 me-2 mt-1 text-xs ps-5'>Rating: <FontAwesomeIcon icon={faStar} className='me-1 text-yellow-400' />9.5/10</p>
                                <p className='text-white/60 me-2 mt-1 text-xs ps-5'>Start Date :</p>
                                <p className='text-white/60 me-2 mt-1 text-xs ps-5'>End Date :</p>
                                <p className='text-white/60 me-2 mt-1 text-xs ps-5'>Status : Planning</p>
                            </div>
                        </div>
