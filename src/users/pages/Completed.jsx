...
import { getCompletedListAPI, putListAPI, putStatusListAPI, updateScoreAPI } from '../../services/allAPIs';
...
const Completed = () => {
    ...
    const getList = async (value) => {
        ...
        const result = await getCompletedListAPI(reqHeader, value)
    ...
    return (
        <>
            <WatchlistCommon completed count={listCount} onHandleSearch={getList} />
