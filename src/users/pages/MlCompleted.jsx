...
import { getCustomCompletedListAPI, putCustomListAPI, putCustomStatusListAPI } from '../../services/allAPIs';
...
const MlCompleted = () => {
    ...
    const getList = async (value) => {
        ...
        const result = await getCustomCompletedListAPI(reqHeader, value)
    ...
    return (
        <>
            <MylistCommon completed count={listCount} onHandleSearch={getList}/>
