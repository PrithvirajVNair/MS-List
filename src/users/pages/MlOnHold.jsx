...
import { getCustomOnHoldListAPI, putCustomListAPI, putCustomStatusListAPI } from '../../services/allAPIs';
...
const MlOnHold = () => {
    ...
    const getList = async (value) => {
        ...
        const result = await getCustomOnHoldListAPI(reqHeader, value)
    ...
    return (
        <>
            <MylistCommon onhold count={listCount} onHandleSearch={getList}/>
